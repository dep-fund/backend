...
async def test_register_success(client: AsyncClient):
    response = await client.post(f"{STANDARD_URL}/register", json={
        "username": "newuser",
        "name": "New",
        "last_name": "User",
...
async def test_get_me_success(client: AsyncClient, standard_user_auth_headers: dict):
    response = await client.get(f"{STANDARD_URL}/me", headers=standard_user_auth_headers)
...
async def test_update_me_success(client: AsyncClient, standard_user_auth_headers: dict):
    response = await client.patch(f"{STANDARD_URL}/me", json={
        "name": "Updated",
        "last_name": "Name",
...
@pytest.mark.asyncio
async def test_change_password_success(client: AsyncClient, standard_user_auth_headers: dict):
    response = await client.post(f"{STANDARD_URL}/me/change-password", json={
...
@pytest.mark.asyncio
async def test_change_password_wrong_old(client: AsyncClient, standard_user_auth_headers: dict):
    response = await client.post(f"{STANDARD_URL}/me/change-password", json={
...
@pytest.mark.asyncio
async def test_change_password_too_short(client: AsyncClient, standard_user_auth_headers: dict):
    response = await client.post(f"{STANDARD_URL}/me/change-password", json={
        "old_password": "UserPassword123!",
        "new_password": "123",
    }, headers=standard_user_auth_headers)
...
async def test_delete_me_success(client: AsyncClient, standard_user_auth_headers: dict):
    response = await client.delete(f"{STANDARD_URL}/me", headers=standard_user_auth_headers)
...
async def test_create_admin_user_success(client: AsyncClient):
    import os
    response = await client.post(ADMIN_URL, json={
...
async def test_admin_update_me_success(client: AsyncClient, admin_auth_headers: dict):
    response = await client.patch(f"{ADMIN_URL}/me", json={
        "name": "UpdatedAdmin",
...
@pytest.mark.asyncio
async def test_admin_change_password_success(client: AsyncClient, admin_auth_headers: dict):
    response = await client.post(f"{ADMIN_URL}/me/change-password", json={
...
@pytest.mark.asyncio
async def test_admin_change_password_wrong_old(client: AsyncClient, admin_auth_headers: dict):
    response = await client.post(f"{ADMIN_URL}/me/change-password", json={
        "old_password": "WrongPassword!",
        "new_password": "NewAdminPass123!",
    }, headers=admin_auth_headers)
...
@pytest.mark.asyncio
async def test_admin_list_users_after_register(client: AsyncClient, admin_auth_headers: dict, standard_user_auth_headers: dict):
    response = await client.get(f"{ADMIN_URL}/users", headers=admin_auth_headers)
...
@pytest.mark.asyncio
async def test_admin_block_user(client: AsyncClient, admin_auth_headers: dict, standard_user_auth_headers: dict):
...
@pytest.mark.asyncio
async def test_admin_block_user_not_found(client: AsyncClient, admin_auth_headers: dict):
