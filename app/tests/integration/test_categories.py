...
async def test_create_category_success(client: AsyncClient, admin_auth_headers: dict):
    response = await client.post(
        ADMIN_URL, json=CATEGORY_PAYLOAD, headers=admin_auth_headers
    )
...
@pytest.mark.asyncio
async def test_create_category_no_description(
    client: AsyncClient, admin_auth_headers: dict
):
    response = await client.post(
        ADMIN_URL, json={"name": "Basketball"}, headers=admin_auth_headers
    )
...
@pytest.mark.asyncio
async def test_create_category_unauthorized_standard_user(
    client: AsyncClient, standard_user_auth_headers: dict
):
    response = await client.post(
        ADMIN_URL, json=CATEGORY_PAYLOAD, headers=standard_user_auth_headers
    )
...
async def test_create_category_missing_name(
    ...
    response = await client.post(
        ADMIN_URL, json={"description": "No name"}, headers=admin_auth_headers
    )
...
@pytest.mark.asyncio
async def test_admin_list_categories_empty(
    client: AsyncClient, admin_auth_headers: dict
):
...
@pytest.mark.asyncio
async def test_admin_list_categories_after_create(
    client: AsyncClient, admin_auth_headers: dict
):
...
@pytest.mark.asyncio
async def test_admin_list_categories_search(
    client: AsyncClient, admin_auth_headers: dict
):
...
@pytest.mark.asyncio
async def test_admin_list_categories_pagination(
    client: AsyncClient, admin_auth_headers: dict
):
    for i in range(5):
        await client.post(
            ADMIN_URL, json={"name": f"Category {i}"}, headers=admin_auth_headers
        )

    response = await client.get(
        f"{ADMIN_URL}?page=1&page_size=3", headers=admin_auth_headers
    )
...
@pytest.mark.asyncio
async def test_admin_get_category_success(
    client: AsyncClient, admin_auth_headers: dict
):
    create_resp = await client.post(
        ADMIN_URL, json=CATEGORY_PAYLOAD, headers=admin_auth_headers
    ...
    response = await client.get(
        f"{ADMIN_URL}/{category_id}", headers=admin_auth_headers
    )
...
@pytest.mark.asyncio
async def test_admin_get_category_not_found(
    client: AsyncClient, admin_auth_headers: dict
):
    fake_id = "00000000-0000-0000-0000-000000000000"
...
@pytest.mark.asyncio
async def test_user_list_categories_empty(
    client: AsyncClient, standard_user_auth_headers: dict
):
...
@pytest.mark.asyncio
async def test_user_list_categories(
...
@pytest.mark.asyncio
async def test_user_get_category_success(
    client: AsyncClient, admin_auth_headers: dict, standard_user_auth_headers: dict
):
    create_resp = await client.post(
        ADMIN_URL, json=CATEGORY_PAYLOAD, headers=admin_auth_headers
    ...
    response = await client.get(
        f"{USER_URL}/{category_id}", headers=standard_user_auth_headers
    )
...
@pytest.mark.asyncio
async def test_user_get_category_not_found(
    client: AsyncClient, standard_user_auth_headers: dict
):
    fake_id = "00000000-0000-0000-0000-000000000000"

    response = await client.get(
        f"{USER_URL}/{fake_id}", headers=standard_user_auth_headers
    )
